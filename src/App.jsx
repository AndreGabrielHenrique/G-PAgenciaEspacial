...
/*
  ...
  - Define globalmente a função window.construcao, que chama o método showAlert do componente Alert (via ref), permitindo exibir alertas de forma global.\n
...
function App() {
  ...
  useEffect(() => {
    // Define a função global window.construcao para exibir alertas com a mensagem passada;
    // se nenhuma mensagem for passada, usa "Em construção..."
    window.construcao = (msg) => {
